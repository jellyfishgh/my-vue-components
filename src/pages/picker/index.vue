<template lang="pug">
  .page
    ...
    .weui-cells
      ...
      area-picker(@confirm="onAreaConfirm" position="center" small)
      area-picker(@confirm="onAreaConfirm" position="right" small isDefault)
...
export default {
  ...
  data() {
    return {
      arr1: createArr(['A', 'B', 'C', 'D', 'E']),
      arr2: createArr(['甲', '乙', '丙', '丁'])
    }
  },
  methods: {
    emptyHandler() {
